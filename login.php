...
<head>
  ...
  <link rel="shortcut icon" href="{{ asset ('assets/dist/img/logo-surya.png') }}">
  <title>Login |PT Surya Satrya Timur</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta name="viewport" content="width=device-width, initial-scale=1">

  <link rel="manifest" href="./manifest.json">
  <link rel="shortcut icon" href="<?= base_url() ?>/assets/dist/img/istana-print.png">
  <!-- Font Awesome -->
  ...
  <div class="login-box">
    ...
    <div class="card">
      <div class="login-logo">
        <br>
        <h2 style="color:green; font-family: Gill Sans, sans-serif;"><b> PT Surya Satrya Timur</b></h2>
        <h3>
          <img src="<?= base_url() ?>/assets/dist/img/logo-surya.png" style="margin-top: 20px; margin-bottom: 20px;" width="180px;" height="150px;">
          <!-- <b><br> AGRARIA DAN TATARUANG/BPN<br> KOTA BANJARMASIN</b></h3> -->
      </div>
      <div class="card-body login-card-body">
        ...
        <form action="" method="POST">
          ...
          <a href="index" class="btn btn-success btn-block btn-xm"><i class="fa fa-reply mr-1"></i> Kembali</a>
          <br>
        </form>
