                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-red">
                                    ...
                                    ?>
                                             <a hhref="#" data-toggle="modal" data-target="#modal_tambah" class="btn bg-blue"><i class="fa fa-plus-circle"> Tambah </i></a><br><br>
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <a href="hapus?id=<?= $row['id_dp'] ?>" class="btn btn-danger btn-sm alert-hapus" title="Hapus"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                            <?php } ?>
                                                </tbody>
