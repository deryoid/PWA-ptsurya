                        ...
                        <div class="col-12">
                            <div class="card card-danger card-outline">
                                <div class="card-header">
                                    ...
                                    <a href="print" target="blank" class="btn bg-yellow"><i class="fa fa-print"> Print</i></a>
                                                ...
                                                <tbody style="background-color: azure">
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            ...
                                                            <a href="edit?id=<?= $row['id_pengeluaran'] ?>" class="btn btn-success btn-sm" title="Edit"><i class="fa fa-edit"></i></a>
                                                            <a href="hapus?id=<?= $row['id_pengeluaran'] ?>" class="btn btn-danger btn-sm alert-hapus" title="Hapus"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            <?php } ?>
