...
<img src="<?=base_url('assets/dist/img/blank.jpg')?>" align="right" width="90" height="90">
  ...
  Filter : <?= $bln[$_POST['bulan']].'/'.$_POST['tahun'] ?>/Belum Diambil <br>
  ...
  <br>
  <h3 style="text-align: center;">Laporan Barang yang Belum Diambil</h3>
                ...
                <table border="1" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        <?php
                            ...
                            WHERE status_pengambilan = 'Belum Diambil' AND MONTH(tanggal_pesan) = '$_POST[bulan]' AND YEAR(tanggal_pesan) = '$_POST[tahun]'");
